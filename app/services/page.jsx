    ...
    return (
      <>
        ...
        <Container>
          <Grid stackable columns='equal' inverted verticalAlign='middle' padded>
            <Grid.Row>
              ...
              <Grid.Column width={6}>
                <Popup position='bottom center' inverted trigger={<Button size='huge' inverted color='yellow'>Whether you're a startup or an established business,</Button>} flowing hoverable>
                  <Grid centered columns={1}>
                    <Grid.Column textAlign='center'>
                      <p className='paragraph-text' inverted>
                        we're here to help you achieve your goals with customized solutions<br />
                        that are tailored to your individual needs and objectives.
                      </p>
                    </Grid.Column>
                  </Grid>
                </Popup>
          ...
          <Suspense fallback={<Dimmer active><Loader size='large'>Loading...</Loader></Dimmer>}>
            <Container textAlign='center'>
              <Header as='h4' inverted className='main-subheader' color='teal' textAlign='center'>
                Press play!
              </Header>
              <Icon name='arrow circle down' className='zoom' color='teal' inverted size='huge'></Icon>
                    ...
                    <List celled inverted relaxed>
                      <List.Item>
                        ...
                        <List.Content id='data'>
                          ...
                          <List.Description as='p' className='paragraph-text'>Data hygiene is the process of cleaning and organizing your data to ensure accuracy and completeness. It involves identifying and correcting errors, duplications, and inconsistencies in your data. A clean and organized database can lead to better decision-making, improved customer experiences, and increased efficiency in your operations.</List.Description>
                          <Image
                          ...
                          <List.Description as='p' className='paragraph-text'>Data automation streamlines your data processes by using software and technology to reduce errors, save time, and increase productivity. This includes automating data entry, data cleaning, and data analysis tasks. By reducing the need for manual work, data automation can improve accuracy, increase efficiency, and free up time for your team to focus on more strategic tasks.</List.Description>
                          <Image
                          ...
                          <List.Description as='p' className='paragraph-text'>A CRM audit is a comprehensive review of your CRM system to identify areas for improvement, optimize performance, and increase ROI. It includes evaluating your data quality, lead management, sales processes, and customer engagement. By uncovering areas of inefficiency or opportunities for improvement, a CRM audit can help you make data-driven decisions to improve your sales and marketing efforts.</List.Description>
                          <Image
                          ...
                          <List.Description as='p' className='paragraph-text'>Data migration involves transferring data from one system to another while ensuring accuracy and security. This includes mapping out data fields, testing data transfers, and verifying data accuracy. By successfully migrating your data, you can minimize downtime and disruptions, avoid data loss or corruption, and ensure your team has access to the information they need to do their jobs effectively.</List.Description>
                        </List.Content>
                      </List.Item>
                    </List>
                  </Grid.Column>
                    ...
                    <List inverted relaxed>
                      <List.Item>
                        ...
                        <List.Content id='revenue'>
                          ...
                          <List.Description as='p' className='paragraph-text'>By improving communication and collaboration between your sales, marketing, and customer service teams, you can increase productivity, reduce churn, and improve customer satisfaction. Our team can help you identify and implement processes and technologies to improve cross-team collaboration and drive revenue growth.</List.Description>
                          <Image
                          ...
                          <Accordion defaultActiveIndex={[0, 2]} exclusive={false} fluid inverted panels={level1Panels} />
                          <Image
                          ...
                          <Accordion defaultActiveIndex={[0, 2]} exclusive={false} fluid inverted panels={level2Panels} />
                          <Image
                            ...
                            className='service-image'
                          />
                          <List.Header as='h2'>Customer Success Teams:</List.Header>
                          <Accordion defaultActiveIndex={[0, 2]} exclusive={false} fluid inverted panels={level3Panels} />
                        </List.Content>
                      </List.Item>
                    </List>
                  </Grid.Column>
                      ...
                      <List.Item>
                        ...
                        <List.Content id='insight'>
                          ...
                          <Image
                            ...
                            verticalAlign='middle'
                          />
                          <List.Header as='h2'>Custom Reports &amp; Dashboards:</List.Header>
                          <List.Description as='p' className='paragraph-text'>Our experts can help you design and implement custom reports and dashboards to track and visualize your key business metrics. By consolidating data and providing real-time insights, you can make data-driven decisions and improve business performance.</List.Description>
                          <Image
                          ...
                          <List.Description as='p' className='paragraph-text'>We can help you implement a full cycle reporting system that tracks your revenue performance from lead generation to customer retention. By identifying and addressing bottlenecks and inefficiencies in your revenue cycle, you can optimize your revenue growth and improve customer satisfaction.</List.Description>
                          <Image
                          ...
                          <List.Description as='p' className='paragraph-text'>Our consultants can help you develop a revenue forecasting model that predicts future revenue growth based on historical data and market trends. By accurately forecasting revenue, you can make informed decisions and develop strategies to improve business performance.</List.Description>
                          <Image
                          ...
                          <List.Description as='p' className='paragraph-text'>Our team can help you map and optimize your customer journey, from initial contact to post-sale engagement. By understanding your customer's needs and pain points, you can provide a seamless and personalized experience that improves customer satisfaction and drives revenue growth.</List.Description>
                        </List.Content>
                      </List.Item>
                    </List>
                  </Grid.Column>
        ...
        <Grid centered stackable inverted>
          <Container>
            <Grid.Row textAlign='center'>
              <Grid.Column className='button-spacing' inverted textAlign='center'>
                <Header as='h4' inverted textAlign='center' color='yellow' className='main-subheader'>
